...
class ApplicationTranslations extends Translations {
  ...
  final Map<String, String> _enUS = <String, String>{
    ...
    'tree_description_explanation_1': 'Enter a tree description below. It can be, for example, a description of its characteristics that distinguish it from other trees of the same species.',
    'tree_description_explanation_2': 'The description is optional,',
    'tree_description_explanation_3': 'but we will be glad if you share your observations. Thanks!',
    'tree_description_hint': 'Enter description...',
    'save': 'Save',
    'add_circumference_title': 'Add the perimeter of the tree',
    'add_circumference_description_1': 'Measure the circumference of the tree. The easiest way to measure is with',
    ...
    'add_tree_condition_description': 'Based on the observations, how to assess the condition of the tree?',
    'add_tree_condition_input_title': 'Can you describe the observed disease?',
    'add_tree_condition_observation_title': 'What did you observe',
    'add_tree_location': 'Mark the exact location of the tree',
    'go_back': 'Go back',
    'cancel': 'Cancel',
    ...
    'retry': 'Retry',
    'camera_denied':  'Camera acces denied. Please got to device settings to change it',
  ...
  final Map<String, String> _plPL = <String, String>{
    ...
    'tree_description_explanation_1': 'Wpisz poniżej opis drzewa. Może to być np. opis jego cech charakterystycznych odróżniających go od innych drzew tego samego gatunku.',
    'tree_description_explanation_2': 'Opis jest nieobowiązkowy,',
    'tree_description_explanation_3': 'ale będzie nam miło jak podzielisz się swoimi spostrzeżeniami. Dzięki!',
    'tree_description_hint': 'Wpisz tutaj swój opis...',
    'save': 'Zapisz',
    'add_circumference_title': 'Dodaj obwód drzewa',
    'add_circumference_description_1': 'Wykonaj pomiar obwodu drzewa. Pomiar najłatwiej wykonasz.',
    ...
    'add_tree_condition_description': 'Na podstawie obserwacji, jak oceniach stan drzewa?',
    'add_tree_condition_input_title': 'Czy jesteś w stanie opisać zaobserwaną chorobę?',
    'add_tree_condition_observation_title': 'Co zaobserwowałeś',
    'add_tree_location': 'Zaznacz dokadne miejsce lokalizacji drzewa',
    'go_back': 'Wróć',
    'cancel': 'Anuluj',
    ...
    'camera_denied':  'Brak dostępu do aparatu. Przejdź do ustawień aplikacji, aby to zmienić',

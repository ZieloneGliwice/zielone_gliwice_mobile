...
class ApplicationTranslations extends Translations {
  ...
  final Map<String, String> _enUS = <String, String>{
    ...
    'add_tree_location': 'Mark the exact location of the tree by long pressing on map',
    'go_back': 'Go back',
    'cancel': 'Cancel',
  ...
  final Map<String, String> _plPL = <String, String>{
    ...
    'add_tree_location': 'Zaznacz lokalizację drzewa przytrzymując palec na mapie',
    'go_back': 'Wróć',
    'cancel': 'Anuluj',

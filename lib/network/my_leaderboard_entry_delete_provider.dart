...
class MyLeaderboardEntryDeleteProvider {
  MyLeaderboardEntryDeleteProvider(this._sessionStorage, this._apiDio);
  ...
  Future<void> deleteEntry() async {
    ...
    await _apiDio.dio.delete(API.deleteEntry, options: options);
  }
}
